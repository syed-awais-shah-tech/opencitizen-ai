...
export const MOCK_SYSTEM_METRICS: SystemMetric[] = [
  {
    ...
    value: 5,
    subtext: "239 pages ready for questions",
    trend: "+2 this week",
    trendType: "positive",
    icon: "document",
  },
  {
    label: "Data Files",
    value: 3,
    subtext: "19,040 records available",
    trend: "All validated",
    trendType: "positive",
    icon: "dataset",
  },
  {
    ...
    value: "100%",
    subtext: "Every answer links to a source",
    trend: "Source citations included",
    trendType: "positive",
    icon: "shield",
  },
  {
    ...
    value: "< 1s",
    subtext: "Answers delivered instantly",
    trend: "Fast and reliable",
    trendType: "positive",
    icon: "activity",
  },
];
